...
/// </summary>
public class UseCaseErrorMAPIMapper : IMapper<UseCaseError, IResult>
{
    /// <summary>
    /// Convierte un error de caso de uso (UseCaseError) en una respuesta HTTP estándar (IResult).
    /// </summary>
    ...
    public IResult Map(UseCaseError err)
    {
        return err switch
        {
